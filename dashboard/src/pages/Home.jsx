        ...
        <section id="how" className="content-section how-section">
          ...
          <div className="features-section">
            ...
            <div className="feature-card">
              ...
              <h3>AI Detection</h3>
              <p>Sylva's computer vision fusion algorithm (using multi-input deep learning architecture) analyzes drone imagery in real-time to identify and classify pollution types including plastic debris, tire dumps, furniture, and hazardous materials. Each detection is assigned a priority level based on size, type, and environmental risk.</p>
