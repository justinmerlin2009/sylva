      ...
      <main className="home-main">
        ...
        <section id="why" className="content-section">
          ...
          <p className="section-description">
            Every year, 8-14 million tons of plastic enter our oceans, causing an estimated $13 billion in damage to marine ecosystems and killing over 100,000 marine animals. California is making significant investments to fight this crisis through initiatives like Caltrans' Clean California program. These efforts are making real progress, but agencies need better tools to prioritize resources and measure impact. Sylva helps these partners become even more effective by providing actionable intelligence. Sylva brings together three key innovations: (1) a hybrid camera with RGB, hyperspectral, and LiDAR sensors for electromagnetic fingerprinting, (2) onboard AI for real-time pollution classification, and (3) water risk scoring that prioritizes threats to waterways. At 500 acres per hour and $0.60 per acre, we give cleanup teams the intelligence to focus where it matters most.
          </p>
